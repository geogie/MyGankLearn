...
import com.george.mcl.View.GlideRoundTransform;
import com.george.mcl.base.AppSwipeBackActivity;
import com.george.mcl.utils.SPUtils;
import com.jerey.downloadmanager.Log;
        ...
        SkinManager.getInstance().loadSkin("theme-night.skin",
                new SkinLoaderListener() {
                    ...
                    public void onFailed(String errMsg) {
                        Log.d(TAG,"theme_night-errMsg"+errMsg);
    ...
    public void onThemeOceanClicked() {
        ...
        SkinManager.getInstance().loadSkin("theme-ocean.skin",
                new SkinLoaderListener() {
                    ...
                    @Override
                    public void onFailed(String errMsg) {
                        Log.d(TAG,"theme_ocean-errMsg"+errMsg);
                        Toast.makeText(getApplicationContext(), "切换失败", Toast.LENGTH_SHORT).show();
                        updateUI();
                    }
